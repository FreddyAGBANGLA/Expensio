...
public class RevenusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter_categorie = ArrayAdapter.createFromResource(getApplicationContext(),
                R.array.categorie_array_revenu, android.R.layout.simple_spinner_item);
        // Specify the layout to use when the list of choices appears
        adapter_categorie.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        // Apply the adapter to the spinner
        spinner_categorie_revenu.setAdapter(adapter_categorie);
        ...
        spinner_categorie_revenu.setOnItemSelectedListener(l_categorie);
        ...
        time.setOnClickListener(v -> {
            ...
            // time picker dialog
            timePickerDialog = new TimePickerDialog(RevenusActivity.this,
        ...
        IB_valider.setOnClickListener(v -> {
            String montant_revenu = etn_montant.getText().toString();

            if (montant_revenu.equals("") || montant_revenu.equals("0")){
